  ...
  return (
    <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-100 dark:border-gray-700/50 hover:border-pink-100 dark:hover:border-pink-800/50">
      <Link href={`/products/${product.slug}`} className="h-full block">
        ...
        <div className="p-4 flex flex-col h-[calc(100%-270px)] sm:h-[calc(100%-220px)] md:h-[calc(100%-270px)]">
          ...
          <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors whitespace-nowrap"
                >
