...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-xl h-full flex flex-col border border-gray-100 dark:border-gray-700/50 hover:border-pink-100 dark:hover:border-pink-800/50">
      <Link href={`/products/${product.slug}`} className="flex flex-col h-full">
        <div className="relative w-full h-48 sm:h-56 md:h-64 overflow-hidden bg-gray-50 dark:bg-gray-800">
            <Image
                src={primaryImage}
          ...
          <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-700/50">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors"
              >
